...
model_path = '../../work_dirs/nusc_deepspeed_svd_front_576320_30f_vista/checkpoint-20000'
...
unet = UNetSpatioTemporalConditionModelMultiviewVista.from_pretrained(unet_path, torch_dtype=torch.float16)
unet.eval()
