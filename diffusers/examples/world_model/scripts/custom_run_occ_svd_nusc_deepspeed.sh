...
WORK=nusc_deepspeed_svd_occ_576320_30f
EXP=nusc_deepspeed_svd_occ


accelerate launch --config_file examples/world_model/configs/4_gpus_deepspeed_zero2.yaml --main_process_port 12000 examples/world_model/custom_train_occ_svd_deepspeed.py \
