...
export DATASET_NAME="../data/nusc_video_all_cam.pkl"
...
accelerate launch --config_file examples/world_model/configs/fsdp.yaml --main_process_port 12000 examples/world_model/train_video_svd_fsdp.py \
 ...
 --config_file examples/world_model/configs/fsdp.yaml --main_process_port 12000 examples/world_model/custom_train_video_svd_fsdp.py \
  --pretrained_model_name_or_path=$MODEL_NAME \
  --dataset_name=$DATASET_NAME \
  --use_ema \
  --train_batch_size 1 \
