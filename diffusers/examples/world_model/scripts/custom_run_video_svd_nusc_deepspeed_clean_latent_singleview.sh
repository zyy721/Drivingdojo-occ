...
WORK=nusc_deepspeed_svd_front_576320_30f_clean_latent_singleview
EXP=nusc_deepspeed_svd_front_clean_latent_singleview


accelerate launch --config_file examples/world_model/configs/4_gpus_deepspeed_zero2.yaml --main_process_port 12000 examples/world_model/custom_train_video_svd_deepspeed_clean_latent_singleview.py \
