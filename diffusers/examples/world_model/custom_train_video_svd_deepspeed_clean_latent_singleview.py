...
from src.model.unet_spatio_temporal_condition_singleview import UNetSpatioTemporalConditionModelSingleview
...
def main():
    ...
    # unet = UNetSpatioTemporalConditionModelMultiview.from_unet_spatio_temporal_condition(unet_origin, **unet_param)
    unet = UNetSpatioTemporalConditionModelSingleview.from_unet_spatio_temporal_condition(unet_origin, **unet_param)
    ...
    if args.use_ema:
        ...
        ema_unet = UNetSpatioTemporalConditionModelSingleview.from_unet_spatio_temporal_condition(unet_origin, **unet_param)
        ema_unet = EMAModel(ema_unet.parameters(), model_cls=UNetSpatioTemporalConditionModelSingleview, model_config=ema_unet.config)  
